          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-96 sm:max-w-lg">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                ...
                <button
                  onClick={sendOtp}
                  className="mt-5 bg-rose-500 w-full h-12 text-white py-2 px-4 rounded"
                >
                ...
                {phone && (
                  <input
                    ...
                    className="mt-3 outline-none border border-gray-300 text-gray-900 text-sm rounded-sm   block w-full p-2.5"
                ...
                {otp && (
                  <button
                    onClick={verifyOtp}
                    className="mt-5 bg-rose-500 w-80 h-12 text-white py-2 px-4 rounded"
                  >
                ...
                {!phone && (
                  <div>
                    ...
                    <div
                      ...
                      className="cursor-pointer mt-5 flex items-center text-center border border-spacing-1 rounded-lg p-3"
                    >
